...
if (isset($_POST["delete_id"])) {
    ...
    try {
        ...
        error_log("Delete flight failed: " . $e->getMessage());
        flash("Unable to delete flight.", "danger");
    }
                    ...
                    <?php else: ?>
                        ...
                        <?php foreach ($flights as $flight): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="view_flight.php?id=<?php echo urlencode($flight["id"]); ?>">
